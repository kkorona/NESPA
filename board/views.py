...
from board.models import Post, Comment, Attach, urllib.parse
...
def edit(request, article_id):
    ...
    if request.method == "POST":
        ...
        for file in files:
            ...
            destination_path = urllib.parse.unquote(os.path.join(settings.BASE_DIR, 'media','attached','notice',str(article.id)))
